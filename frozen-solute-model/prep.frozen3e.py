...
# usage: prep.frozen3e.py <compound_id> <local_path> <remote_host>
...
subprocess.run(["cp", f"data/{xyz_path}/2_OPTIMIZATION.out", "."], check=True)

# get step 2a conf
conformers = dict()
with open(f"data/{xyz_path}/2_OPTIMIZATION.out") as f:
    # skip header
    f.readline()
    f.readline()
